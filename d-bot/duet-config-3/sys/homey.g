...
;
; 12/10/2020: Modified to use meta commands to speeds things up a bit
...
if {!move.axes[2].homed || {move.axes[2].userPosition <= 10}}
   ...
   ;
   G91              ; relative positioning
   G1 H1 Y295 F1800 ; move quickly to Y axis endstop and stop there (first pass)
   G1 Y-5 F6000     ; go back a few mm
   G1 H1 Y295 F360  ; move slowly to Y axis endstop once more (second pass)
   G1 Y-5           ; clear off the endstop
   G90              ; absolute positioning
   ;
