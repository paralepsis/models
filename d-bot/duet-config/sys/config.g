...
; PRIOR TO ACCELERATING (1/14/2018)
; M203 X7200 Y7200 Z365 E1200     ; Set maximum speeds (mm/min)
; M201 X500 Y500 Z250 E300        ; Normal (printing) accelerations (mm/s^2)
; M202 X500 Y500                  ; Travel accelerations (mm/s^2) -- NOT SUPPORTED
; M566 X900 Y900 Z12 E120         ; Set maximum instantaneous speed changes (mm/min)

; Heaters
M143 S270 ; Set maximum heater temperature to 260C

; M307 H0 A67.9 C260.8 D2.5 S0.80 B0 ; Set PID controls with new (M307) parameters, calculated for 80% PWM max. (OLD DIRECT POWERED)
