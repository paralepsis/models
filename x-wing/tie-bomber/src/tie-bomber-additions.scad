...
translate([-19,-7.2,13]) rotate([0,90,0]) scale([1,1.35,1]) cylinder(r1=3,r2=1.55,h=4);
mirror([1,0,0]) translate([-19,-7.2,13]) rotate([0,90,0]) scale([1,1.35,1]) cylinder(r1=3,r2=1.55,h=4);
