...
/* Dial Configuration:
 * Pick a configuration. For use on Thingiverse, copy the
 * "dial-configurable.scad" contents in at this point (simplest way).
 */
// include <dial-configurable.scad>
include <dial-tie-phantom.scad>
