...
bottomDial();
straightArrow();
translate([-1.3,8,0]) scale([0.5,0.5,3]) drawtext("3");

// translate([0,0,12]) topDial();
...
module straightArrow() {
	translate([0,13,0]) linear_extrude(height=3) {
